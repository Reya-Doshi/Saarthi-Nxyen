...
export default function RelaxationVideos() {
    return (
        <>
            
<div className="page-transition"></div><div className="scroll-progress" id="scrollProgress"></div>
<header className="site-header"><nav className="nav container"><Link to="/" className="logo">Saarthi</Link><button className="nav-toggle" id="navToggle" aria-label="Toggle navigation">☰</button><ul className="nav-links" id="navLinks"><li><Link to="/">Home</Link></li><li><Link to="/healthcare">Healthcare</Link></li><li className="nav-item dropdown"><button className="dropdown-toggle" type="button">Work</button><ul className="dropdown-menu"><li><Link to="/work">Employees</Link></li><li><Link to="/teams">Teams</Link></li></ul></li><li className="nav-item dropdown"><button className="dropdown-toggle active" type="button">Resources</button><ul className="dropdown-menu"><li><Link to="/reports">Reports</Link></li><li><Link to="/clinical-evidence">Clinical Evidence</Link></li><li><Link to="/case-studies">Case Studies</Link></li><li><Link to="/blog">Blog</Link></li><li><Link to="/quizzes">Quizzes</Link></li><li><Link to="/games">Games</Link></li><li><Link className="active" to="/relaxation-videos">Relaxation Videos</Link></li><li><Link to="/meditation-audios">Meditation Audios</Link></li></ul></li><li><Link to="/about">About Us</Link></li><li><Link to="/ai-support">AI Support</Link></li><li><Link to="/journal">Journal</Link></li><li><Link to="/book-demo">Book Demo</Link></li></ul><button className="theme-toggle" id="themeToggle" aria-label="Toggle dark mode"><span className="icon-sun">☀</span><span className="icon-moon">☾</span></button></nav></header>
<main>
<section className="section hero mini-hero"><div className="container reveal narrow center"><h1>Relaxation Videos</h1><p className="lead">Six embedded videos for calm breathing and guided reset.</p></div></section>
<section className="section"><div className="container reveal"><div className="grid three-grid">
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/lFcSrYw-ARY" title="Relaxation video 1" allowfullscreen></iframe></article>
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/inpok4MKVLM" title="Relaxation video 2" allowfullscreen></iframe></article>
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/77ZozI0rw7w" title="Relaxation video 3" allowfullscreen></iframe></article>
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/aEqlQvczMJQ" title="Relaxation video 4" allowfullscreen></iframe></article>
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/v7AYKMP6rOE" title="Relaxation video 5" allowfullscreen></iframe></article>
<article className="card resource-card"><iframe src="https://www.youtube.com/embed/sTANio_2E0Q" title="Relaxation video 6" allowfullscreen></iframe></article>
</div></div></section>
</main>
