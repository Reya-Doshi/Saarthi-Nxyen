    ...
    <header className="site-header">
        <nav className="nav container">
            ...
            <ul className="nav-links" id="navLinks">
                ...
                <li><Link className="active" to="/ai-support">AI Support</Link></li>
    ...
    <main>
        <section className="section hero mini-hero">
            <div className="container reveal narrow center">
                <h1>AI Support</h1>
                <p className="lead">Talk with Saarthi AI directly here on the page.</p>
            </div>
        </section>

        <section className="section">
            <div className="container reveal">
                <div className="chatbase-inline-panel">
                    <iframe
                        src="https://www.chatbase.co/chatbot-iframe/YNkWz6hB820EfUazNDIkf"
                        title="Saarthi AI Chat"
                        allow="clipboard-write; microphone"
                    ></iframe>
                </div>
                <p className="chatbase-inline-note">If chat does not load, please check browser privacy/ad-block settings and refresh.</p>
            </div>
        </section>
    </main>
