...
function enhanceNavbar() {
    ...
    const hasJournal = [...links].some((a) => a.getAttribute("href") === "journal.html");
    if (!hasJournal) {
        const journalLi = document.createElement("li");
        journalLi.innerHTML = '<a href="journal.html">Journal</a>';
        const bookDemoLi = [...navLinks.children].find(
            (li) => li.querySelector('a[href="book-demo.html"]')
        );
        if (bookDemoLi) {
    ...
    if (!existingProfile) {
        ...
        profile.innerHTML = `
            ...
            <ul class="profile-dropdown">
                ...
                <li><a href="journal.html#saved">Saved Journals</a></li>
